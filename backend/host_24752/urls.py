...
admin.site.site_header = "HOST"
admin.site.site_title = "HOST Admin Portal"
admin.site.index_title = "HOST Admin"

# swagger
api_info = openapi.Info(
    title="HOST API",
    default_version="v1",
    description="API documentation for HOST App",
)
